...
public class TcpConnection extends SelectionKeyHandler implements Comparable
{
    ...
    */
    ...
    {
        /*
        InetSocketAddress remoteSocketAddr = (InetSocketAddress)socketChannel_.socket().getRemoteSocketAddress();
        InetSocketAddress localSocketAddr = (InetSocketAddress)socketChannel_.socket().getLocalSocketAddress();
        return localSocketAddr.getHostName() + ":" + localSocketAddr.getPort() + " ----> " + remoteSocketAddr.getHostName() + ":" + remoteSocketAddr.getPort();
        */
    ...
    {       
        ...
        {               
            logger_.warn("Encountered IOException on connection: "  + this);
            ...
            {           
                ...
                {                       
                    ...
                    {                        
                        ...
                        if (remoteEp_ == null)
                        {                                          
                            remoteEp_ = new EndPoint( socketChannel_.socket().getInetAddress().getHostName(), DatabaseDescriptor.getStoragePort() );                            
