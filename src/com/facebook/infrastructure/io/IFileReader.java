...
public interface IFileReader
{
    ...
    */
     ...
     *
     * @param dos - DataOutputStream that needs to be filled.
     * @param column name of the column we are interested in.
     * @throws IOException
     * @return number of bytes read.
    */
    public long next(DataOutputBuffer bufOut, String column) throws IOException;
    ...
    */
    public long next(String key, DataOutputBuffer bufOut, String column) throws IOException;
     ...
     *
    */
    public long next(String key, DataOutputBuffer bufOut, String columnFamilyName, List<String> columnNames) throws IOException;
