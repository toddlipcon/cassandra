...
public class batch_mutation_super_t implements TBase, java.io.Serializable {
  public String table;
  public String key;
  public AbstractMap<String,ArrayList<superColumn_t>> cfmap;
  ...
  public batch_mutation_super_t(
    String table,
    String key,
    AbstractMap<String,ArrayList<superColumn_t>> cfmap)
  {
    this();
    this.table = table;
          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.cfmap = new HashMap<String,ArrayList<superColumn_t>>(2*_map13.size);
              for (int _i14 = 0; _i14 < _map13.size; ++_i14)
              {
                String _key15;
                ArrayList<superColumn_t> _val16;
