 ...
 * keys at an Endpoint. Monitor load infomation for a 20 minute
...
final class StorageLoadBalancer implements IEndPointStateChangeSubscriber, IComponentShutdown
{
    ...
    class MoveMessageVerbHandler implements IVerbHandler
    {
        public void doVerb(Message message)
        {
            ...
            if ( isMoveable_.get() )
            {
                ...
                lbOperations_.submit( new RunnableImpl(targetToken) );
    ...
    /*
     * This class performs the actual leave/join operation
     * for this node.
     * TODO: A better name is in order.
    */
    class RunnableImpl implements Runnable
    {
        private BigInteger targetToken_;

        RunnableImpl(BigInteger targetToken)
        {
